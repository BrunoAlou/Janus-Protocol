 ...
 */
import {
  createFlagsDebugUI as createFlagsDebugUIPanel,
  destroyFlagsDebugUI as destroyFlagsDebugUIPanel,
  updateFlagsDebugUI as updateFlagsDebugUIPanel,
  createFlagRow as createFlagRowPanel,
  truncateFlagText as truncateFlagTextPanel,
  clearFlagRows as clearFlagRowsPanel,
  showDebugToast as showDebugToastPanel,
  layoutFlagsDebugUI as layoutFlagsDebugUIPanel
} from './collision/flagsPanel.js';
...
export default class CollisionDebugger {
  ...
  createFlagRow(flagKey, flagValue, index) {
    createFlagRowPanel(this, flagKey, flagValue, index);
  }

  truncateFlagText(text, maxLength = 18) {
    return truncateFlagTextPanel(text, maxLength);
  }
  ...
  showDebugToast(message, color = 0x222222) {
    showDebugToastPanel(this, message, color);
  }
